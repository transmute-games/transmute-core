...
public class ImageManager
{
    ...
    public static Map<String, BufferedImage> IMAGE_MAP = new HashMap<>(); //The {@code HashMap<>()} used to hold the images
     ...
     *
     * @param key The lower-cased key attached to the image.
     * @param image The image to add to the hash table.
     */
    public static void add(String key, BufferedImage image)
    {
        ImageManager.IMAGE_MAP.put(key, image);
     ...
     */
    public static BufferedImage get(String name, boolean isKey)
    {
        String key = "";
