 ...
 */
public abstract class Meteor implements Runnable, Cortex {
	public static final String ENGINE_TITLE = "Meteor"; //The game engine title
	...
	public Meteor(String gameTitle, String gameVersion, int gameWidth, int gameRatio, int gameScale) {
		printStartScreen();
	 ...
	 */
	@SuppressWarnings("static-access")
	public Meteor(GameWindow window, String gameVersion) {
        printStartScreen();
